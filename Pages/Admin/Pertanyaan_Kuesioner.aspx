    ...
    <asp:Panel runat="server" ID="panelView">
        ...
        <div style="overflow-x: auto; width: 100%;">
            <asp:GridView runat="server" ID="gridDataPertanyaanKuesioner" CssClass="table table-hover table-bordered table-condensed table-striped grid scrollstyle" AllowPaging="true"
                ...
                ShowHeaderWhenEmpty="true" OnPageIndexChanging="gridDataPertanyaanKuesioner_PageIndexChanging" OnRowCommand="gridDataPertanyaanKuesioner_RowCommand" EmptyDataRowStyle-HorizontalAlign="Center">
                    ...
                    <asp:TemplateField HeaderText="Aksi" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:HyperLink Text="Ubah" ID="linkUbah" rel="tooltip" runat="server" data-placement="bottom"
                                title="Ubah Pertanyaan Kuesioner" NavigateUrl='<%# "Pertanyaan_Kuesioner_Edit.aspx?id=" + Eval("id_pku")  %>'
                                Visible="true">
                            <i class="fa fa-edit" aria-hidden="true"></i>
                            </asp:HyperLink>&nbsp;
                            <asp:HyperLink Text="Hapus" ID="linkHapus" rel="tooltip" runat="server" data-placement="bottom"
                                title="Hapus Pertanyaan Kuesioner" NavigateUrl='<%# "Pertanyaan_Kuesioner_Hapus.aspx?id=" + Eval("id_pku")  %>'
                                Visible="true">
