<%@ Page Title="Jawaban Kuesioner" Language="C#" MasterPageFile="~/Layouts/Template.Master" AutoEventWireup="true" CodeBehind="Jawaban_Kuesioner_Edit.aspx.cs" Inherits="study_tracer.Pages.Admin.Jawaban_Kuesioner_Edit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Jawaban Kuesioner Edit - Tracer Study</title>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-group">
        ...
        <asp:DropDownList runat="server" CssClass="form-control" ID="ddlPertanyaan" Enabled="false">
        </asp:DropDownList>
    </div>
    ...
    <asp:LinkButton ID="btnKirim" OnClick="btnKirim_Click" CssClass="btn btn-primary btn-block mb-1" runat="server"><i class="fa fa-floppy-o"></i>&nbsp;Edit Data Jawaban Kuesioner</asp:LinkButton>
</asp:Content>
