<%@ Page Title="Pertanyaan Kuesioner" Language="C#" MasterPageFile="~/Layouts/Template.Master" AutoEventWireup="true" CodeBehind="Pertanyaan_Kuesioner_Edit.aspx.cs" Inherits="study_tracer.Pages.Admin.Pertanyaan_Kuesioner_Edit" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Pertanyaan Kuesioner Edit - Tracer Study</title>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:LinkButton ID="btnKirimm" OnClick="btnKirimm_Click" CssClass="btn btn-primary btn-block mb-1" runat="server"><i class="fa fa-floppy-o"></i>&nbsp;Edit Data Pertanyaan Kuesioner</asp:LinkButton>
</asp:Content>
