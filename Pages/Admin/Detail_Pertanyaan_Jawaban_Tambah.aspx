<%@ Page Title="Detail Pertanyaan Jawaban" Language="C#" MasterPageFile="~/Layouts/Template.Master" AutoEventWireup="true" CodeBehind="Detail_Pertanyaan_Jawaban_Tambah.aspx.cs" Inherits="study_tracer.Pages.Admin.Detail_Pertanyaan_Jawaban_Tambah" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Detail Pertanyaan Jawaban Tambah - Tracer Study</title>
</asp:Content>
