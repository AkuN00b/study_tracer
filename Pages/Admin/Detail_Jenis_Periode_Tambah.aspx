<%@ Page Title="Detail Jenis Periode" Language="C#" MasterPageFile="~/Layouts/Template.Master" AutoEventWireup="true" CodeBehind="Detail_Jenis_Periode_Tambah.aspx.cs" Inherits="study_tracer.Pages.Admin.Detail_Jenis_Periode_Tambah" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Detail Jenis Periode Tambah - Tracer Study</title>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:LinkButton ID="btnKirim" OnClick="btnKirim_Click1" CssClass="btn btn-primary btn-block mb-1" runat="server"><i class="fa fa-floppy-o"></i> Tambah Data Detail Jenis Periode</asp:LinkButton>
</asp:Content>
